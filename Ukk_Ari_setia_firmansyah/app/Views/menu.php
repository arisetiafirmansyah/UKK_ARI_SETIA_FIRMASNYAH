    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">
          <img src="<?php echo  base_url('images/pe.JPG')?>">
        </div>
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="/home/user">User</a>
            <a class="collapse-item" href="/home/petugas">Petugas</a> 
               <a class="collapse-item" href="/home/peminjam">Peminjam</a> 
     ...
     <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/home/buku">Buku</a>
           
             <a class="collapse-item" href="/home/ulasan">Ulasan</a>

             <a class="collapse-item" href="/home/katagori">Katagori</a>
             <a class="collapse-item" href="/home/katagoribuku">Katagori Buku</a>
          </div> 
        </div>
      </li>
      ...
      <!-- <li class="nav-item">
        ...
        <div id="collapsePage" class="collapse" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/home/peminjaman">Peminjaman</a>
            <a class="collapse-item" href="/home/koleksi">Koleksi</a> 
            <a class="collapse-item" href="/home/ulasan">Ulasan</a>
          </div>
        </div>
      </li>  -->
